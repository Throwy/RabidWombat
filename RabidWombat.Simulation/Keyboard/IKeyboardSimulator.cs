...
namespace RabidWombat.Simulation.Keyboard
{
    ...
    public interface IKeyboardSimulator
    {
        ...
        /// </summary>
        /// <param name="keyCodes">The list of <see cref="VirtualKeyCode"/>s for the keys to be simulated</param>
        ...
        /// <param name="keyCodes">The list of <see cref="VirtualKeyCode"/>s for the keys to simulate.</param>
        IKeyboardSimulator ModifiedKeyStroke(VirtualKeyCode modifierKeyCode, IEnumerable<VirtualKeyCode> keyCodes);

        /// <summary>
        /// Simulates a simple modified keystroke like CTRL-C where CTRL is the modiferKey and C is the key.
        ...
        /// </summary>
        /// <param name="character">The unicode character to simulate.</param>
