...
using RabidWombat.Simulation.Native;
using System;
using System.Collections.Generic;
using System.Threading;

namespace RabidWombat.Simulation.Keyboard
{
    /// <summary>
    /// Implements the <see cref="IKeyboardSimulator"/> interface by calling the <see cref="IInputMessageDispatcher"/> to simulate keyboard gestures.
    /// </summary>
    public class KeyboardSimulator : IKeyboardSimulator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyboardSimulator"/> class using an instance of <see cref="WindowsInputMessageDispatcher"/> for dispatching <see cref="INPUT"/> messages.
        /// </summary>
        ...
        internal KeyboardSimulator(IInputSimulator inputSimulator, IInputMessageDispatcher messageDispatcher)
        {
            ...
            _messageDispatcher = messageDispatcher ?? throw new InvalidOperationException(
                string.Format("The {0} cannot operate with a null {1}. Please provide a valis {1} instance to use for dispatching {2} messages.",
        ...
        /// </summary>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> to simulate.</param>
        ...
        /// <summary>
        /// Calls the Win32 SendInput method with KeyDown and KeyUp message in the same input sequence in order to simulate a Key PRESS.
        /// </summary>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> to simulate.</param>
        ...
        /// </summary>
        /// <param name="keyCodes">The list of <see cref="VirtualKeyCode"/> to simulate.</param>
        ...
        {
            ModifiedKeyStroke(new[] { modifierKeyCode }, keyCodes);
            return this;
        }
