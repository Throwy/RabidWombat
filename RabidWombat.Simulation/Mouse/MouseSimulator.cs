...
{
    /// <summary>
    /// Implements the <see cref="IMouseSimulator"/> interface by calling the <see cref="IInputMessageDispatcher"/> to simulate Mouse gestures.
    /// </summary>
    public class MouseSimulator : IMouseSimulator
    {
        ...
        /// </summary>
        /// <param name="pixelDeltaX">The distance to move the mouse horizontally.</param>
        /// <param name="pixelDeltaY">The distance to move the mouse vertically.</param>
